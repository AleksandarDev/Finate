...
namespace Finate.UWP.Logging.Sinks.Raygun
{
    ...
    {
        /// <summary>
        /// Adds a sink that writes log events (defaults to error and up) to the Raygun.io web service. Properties are being send as data and the level is used as a tag.
        ...
        /// <param name="userNameProperty">Specifies the property name to read the user name from. By default it is UserName. Set to null if you do not want to use this feature.</param>
        ...
        public static LoggerConfiguration Raygun(
            ...
            IEnumerable<Type> wrapperExceptions = null, string userNameProperty = "UserName",
            ...
            IEnumerable<string> ignoredFormFieldNames = null)
        {
            ...
            return loggerConfiguration.Sink(
                new RaygunSink(formatProvider, applicationKey, wrapperExceptions, userNameProperty,
                    applicationVersionProperty, tags, ignoredFormFieldNames),
